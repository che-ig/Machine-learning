...
Strikethrough uses two tildes. ~~Scratch this.~~ [#my-multi-word-header]
...
Внитри текста оставляем перекрестную ссылу на раздел  [зачеркивания](#Зачеркивание)
URLs and URLs in angle brackets will automatically get turned into links.
http://www.example.com or <http://www.example.com> and sometimes 
example.com (but not on Github, for example).

Some text to show [quote](#quote) that the reference links can follow later.
...
! ssss
```
### Якоря на внутренние элементы документа
[якорь на Таблицы](#Таблицы)

[ознакомпться с цитатами](#quote)
